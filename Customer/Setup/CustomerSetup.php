...
namespace Orange\Customer\Setup;
...
class CustomerSetup extends EavSetup {
	...
	public function installCustomerAttributes($customerSetup) {
		...
		$customerSetup->getEavConfig()->getAttribute('customer', 'company_name')->setData('is_user_defined',1)->setData('is_required',0)->setData('default_value','')->setData('used_in_forms', ['adminhtml_customer', 'checkout_register', 'customer_account_create', 'customer_account_edit'])->save();	
	} 
